<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="mjeksia.aspx.cs" Inherits="unibook.mjeksia" %>
<!DOCTYPE html>
...
<body>
 ...
 <LevelMenuItemStyles>
    ...
    <asp:MenuItemStyle CssClass="level2"/>
           ...
           <items>
    <asp:menuitem text="UNIVERSITETI I MJEKESISE" selectable="false">
    <asp:menuitem text="Fakulteti i Mjekesise" tooltip="Fakulteti i Mjekesise">
    </asp:menuitem>
    <asp:menuitem text="Fakulteti i Shkencave Mjekesore Teknike" tooltip="Fakulteti i Shkencave Mjekesore Teknike">
      </asp:menuitem>
      <asp:menuitem text="Fakulteti i Mjekesise Dentare" tooltip="Fakulteti Mjekesise Dentare"/>
    </asp:menuitem>
  </items>
       </asp:menu>
     </div>
