<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="bujqesori.aspx.cs" Inherits="unibook.bujqesori" %>
...
<body>
    <form id="form1" runat="server">
      ...
      <div>
       <asp:menu  id="NavigationMenu" dynamichorizontaloffset="10" staticdisplaylevels="2" staticsubmenuindent="10" target="_blank" runat="server"  BorderColor="Orange" BorderStyle="Solid">
 <LevelMenuItemStyles>
    ...
    <asp:MenuItemStyle CssClass="level2"/>
           ...
           <items>
    <asp:menuitem text="UNIVERSITETI BUJQESOR" selectable="false">
    <asp:menuitem text="Fakulteti i Bujqesise dhe Mjedisit" tooltip="Fakulteti i Bujqesise Dhe Mjedisit">
    </asp:menuitem>
    <asp:menuitem text="Fakulteti i Ekonomise dhe Agrobiznesit" tooltip="Fakulteti i Ekonomise dhe Agrobiznesit">
      </asp:menuitem>
      <asp:menuitem text="Fakulteti i Bioteknologjise dhe Ushqimit" tooltip="Fakulteti i Bioteknologjise dhe Ushqimit"/>
        <asp:MenuItem Text="Fakulteti i Shkencave Pyjore" ToolTip="Fakulteti i Shkencave Pyjore">
        </asp:MenuItem>
        <asp:MenuItem Text="Fakulteti i Mjekesise Veterinare" ToolTip="Fakulteti i Mjekesise Veterinare">
        </asp:MenuItem>
    </asp:menuitem>
  </items>
       </asp:menu>
