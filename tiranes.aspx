<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="tiranes.aspx.cs" Inherits="unibook.tiranes" %>
<!DOCTYPE html>
...
<head runat="server">
    <title>Universiteti i Tiranes</title>
    <style>
body{
    background:skyblue;
    margin:0;
...
<body>
 ...
 <LevelMenuItemStyles>
    ...
    <asp:MenuItemStyle CssClass="level2"/>
           ...
           <items>
    <asp:menuitem text="UNIVERSITETI I TIRANES" selectable="false">
    <asp:menuitem text="Fakulteti i Ekonomise" tooltip="Fakulteti i Ekonomise">
    </asp:menuitem>
    <asp:menuitem text="Fakulteti i Drejtesise" tooltip="Fakulteti i Drejtesise">
      </asp:menuitem>
      <asp:menuitem text="Fakulteti i Historise dhe Filologjise" tooltip="Fakulteti Histori-Filologji"/>
        <asp:MenuItem Text="Fakulteti i Gjuheve te Huaja" ToolTip="Fakulteti i Gjuheve te Huaja">
        </asp:MenuItem>
        <asp:MenuItem Text="Fakulteti i Shkencave Sociale" ToolTip="Fakulteti i Shkencave Sociale">
        </asp:MenuItem>
        <asp:MenuItem Text="Fakulteti i Shkencave te Natyres" ToolTip="Fakulteti i Shkencave te Natyres">
        </asp:MenuItem>
    </asp:menuitem>
  </items>
       </asp:menu>
     </div>
   <asp:GridView ID="Detail" runat="server" CssClass="auto-style3" Height="116px" Width="401px" AutoGenerateColumns="False" style="margin-left: 448px" BackColor="#CCCCCC" BorderColor="#999999" BorderStyle="Solid" BorderWidth="3px" CellPadding="4" CellSpacing="2" ForeColor="Black">
                      <Columns> 
